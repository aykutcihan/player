...
def main():
    playlist = PLAYLIST.read_text(encoding='utf-8')
        ...
        for base, site_key in SITES:
            ...
            for cat in CATS:
                ...
                for ch_name, slug in slugs:
                    ...
                    streams = []
                    try:
                        page.on('request', lambda r, s=streams: s.append(r.url)
                        ...
                        page.remove_listener('request', lambda r, s=streams: None)
                    except Exception:
                        pass
