...
export default function EpgPanel({ channelId, streamUrl = '', onSelectPast }: Props) {
  ...
  // Yüklendikten sonra "şu an"a scroll et
  useEffect(() => {
  ...
  return (
    <div className="p-3 flex flex-col gap-2">
      ...
      {/* Geçmiş — üstte, scroll ile ulaşılır */}
      {past.length > 0 && (
        <>
          <div className="text-xs text-white/40 font-medium px-1 flex items-center gap-1">
            Geçmiş
      ...
      {/* Şu an — her zaman görünür */}
      {current && (
        <div ref={currentRef} className="bg-red-900/30 rounded p-3 border border-red-500/30">
